/*
  # Create Demo Account and Store

  1. Changes
    - Create demo user in auth schema
    - Create profile for demo user
    - Create initial store for demo account

  2. Security
    - Demo user is created with email confirmation
    - Profile and store follow existing RLS policies
*/
